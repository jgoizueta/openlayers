...
OpenLayers.Layer.Google.v3 = {
    ...
    /** 
     * APIProperty: enableTilt 
     * {Boolean} If set to true, Google's 45-degree tilt view will be enabled. 
     *     Default is false, which disables 45-degree tilt. 
     *     Note that enabling 45-degree tilt may cause problems with overlays and markers matching up to the map. 
     */ 
    enableTilt: false,
